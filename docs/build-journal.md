# Path Pilot — build journal

> Historical engineering narrative preserved from the former repository homepage. Some
> provider names and measurements reflect the system at the time they were written. For
> the current architecture and latest evaluation, start with the
> [repository README](../README.md) and the
> [latest evaluation report](../api/eval/results/report-20260817-204835.md).
...
<p align="center">
  <img src="assets/path-pilot-demo.png" alt="Path Pilot demo sign-in screen with two fictional student scenarios" width="900" />
</p>
